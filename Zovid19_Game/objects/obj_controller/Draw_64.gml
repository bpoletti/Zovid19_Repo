if instance_exists(obj_player) {
	...
	if (obj_player.weapon == Guns.pistol) {
		...
		draw_text(x, y+80, "Ammo in Mag: " + string(obj_player.pistol_ammo_remain));
		...
		draw_text(x, y+80, "Ammo in Mag: " + string(obj_player.rifle_ammo_remain));
		...
		draw_text(x, y+80, "Ammo in Mag: " + string(obj_player.LMG_ammo_remain));
		...
		draw_text(x, y+80, "Ammo in Mag: " + string(obj_player.shotgun_ammo_remain));
