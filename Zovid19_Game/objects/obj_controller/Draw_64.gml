if instance_exists(obj_player) {
	...
	if (obj_player.weapon == Guns.pistol) {
		draw_sprite(spr_pistol2,  0, 30, 650)
		...
		if(obj_player.overGun == true) {
			draw_text(x+500, y+230, "Press (E) to pick up pistol");
		...
		draw_sprite(spr_rifle2,  0, 30, 650)
		...
		if(obj_player.overGun == true) {
			draw_text(x+500, y+230, "Press (E) to pick up rifle");
			obj_player.overGun = false
		} else {
			draw_text(x+500, y+230, " ");
		}
		...
		if(obj_player.overGun == true) {
			draw_text(x+500, y+230, "Press (E) to pick up LMG");
			obj_player.overGun = false
		} else {
			draw_text(x+500, y+230, " ");
		}
		...
		draw_sprite(spr_shotgun2,  0, 30, 650)
		...
		if(obj_player.overGun == true) {
			draw_text(x+500, y+230, "Press (E) to pick up shotgun");
			obj_player.overGun = false
		} else {
			draw_text(x+500, y+230, " ");
		}
